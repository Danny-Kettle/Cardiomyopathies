    ...
    <div class="bg-gray-100 flex flex-col gap-8 p-20 shadow-xl">
      ...
      <div class="flex flex-col gap-6 mb-10">
        ...
        <div class="flex flex-row items-center">
          <label class="font-bold text-sm tracking-wider w-28 uppercase text-slate-600"
            >username</label
          >
          <input v-model="userData.username" class="px-3 py-1 shadow-sm rounded" />
        </div>
        <div class="flex flex-row items-center">
          <label class="font-bold w-28 text-sm tracking-wider uppercase text-slate-600"
            >First Name</label
          >
        ...
        <button
          @click="submitForm"
          class="w-32 rounded self-end bg-emerald-400 text-white py-4 px-4 font-bold text-xs uppercase transform duration-300 origin-center ease-in-out hover:scale-110 shadow"
        >
          Save Account
        </button>
      </div>
      ...
      <div class="flex flex-col">
        <div class="flex flex-col w-full justify-between">
          ...
          <div class="flex flex-row gap-8">
            ...
            >
              <i class="fa-solid fa-expand"></i> View Table
            </button>
            <button
            ...
            >
              <i class="fa fa-plus" /> Add Record
            </button>
            <button
              @click="isMutationModal = !isMutationModal"
            ...
            >
              <i class="fa fa-plus" /> Add Mutation
            </button>
            <button
            ...
            >
              <i class="fa fa-plus" /> Add Patient
            </button>
          </div>
        </div>
        ...
        <AddMutationComponent
          v-if="isMutationModal"
          @close-mutation-modal="isMutationModal = !isMutationModal"
        />
      </div>
    </div>
  </div>
